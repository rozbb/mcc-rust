...
// Takes about 5 minutes with 5 tries per byte and 9 minutes with 10 tries per byte; both work as
// long as there are no other intensive processes running on the computer at the same time
